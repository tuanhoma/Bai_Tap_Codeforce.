...
if(compare_max_last != l){
	...
	//max
	float tamp1 = (float)compare_max / 2;
	if(tamp1 > compare_minus){
	float result_max = (float)max_area(n, a);
	printf("%lf", result_max / 2);
    }
    
	//min
	if(compare_minus > tamp1){
	float result_min = (float)min_last(n, a, l);
	printf("%lf", result_min);
    }
}	
...
//===============================================	
	...
	//max
	float tamp = (float)compare_max / 2;
	if(tamp > compare_min){
	float result_max = (float)max_area(n, a);
	printf("%lf", result_max / 2);
    }
	...
	//min
	if(compare_min > tamp){
	float result_min = (float)min_area(n, a);
	printf("%lf", result_min);
    }
}
